...
public class SwerveDrive extends SubsystemBase {
  ...
  public Command driveCommand(Supplier<ChassisSpeeds> chassisSpeedsSupplier) {
    return new RepeatCommand(new RunCommand(() -> drive(chassisSpeedsSupplier.get()), this));
  }
            ...
            () -> {
              ...
              if (isFirstPath) {
                swerveDriveOdometry.resetPosition(
                    traj.getInitialHolonomicPose(), getGyroscopeRotation()); // Add the SwerveModulePositions
              }
            }),
