...
public class BlueMidToCSOutCommunity extends SequentialCommandGroup{
    public BlueMidToCSOutCommunity() {
        String path = "BLUE Mid Score to CS with Leaving Community";
